  ...
  const footerSections = [
    {
      title: 'Our eSIMs',
      links: [
        { name: 'Kenya eSIM', href: '#' },
        { name: 'Tanzania eSIM', href: '#' },
        { name: 'Uganda eSIM', href: '#' },
        { name: 'Rwanda eSIM', href: '#' },
        { name: 'Burundi eSIM', href: '#' },
        { name: 'East Africa Bundle', href: '#' },
      ],
    },
    {
      title: 'Company',
      links: [
        { name: 'About AfriRoam', href: '#' },
